...
devkitroot='/home/abhimanyudubey/voc-release5/VOC2007/VOCdevkit';

% change this path to point to your copy of the PASCAL VOC data
VOCopts.datadir=[devkitroot '/'];

if isdeployed
	VOCopts.resdir=[devkitroot '/results/deploy/' VOCopts.dataset '/'];
else
...
if isdeployed
	VOCopts.localdir=[devkitroot '/local/deploy/' VOCopts.dataset '/'];
else
